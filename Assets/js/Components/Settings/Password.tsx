...
class Password extends React.Component<any, any>{
  ...
  handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    Axios.post('/api/updatePassword', {oldPassword, newPassword, rePassword}).then((res: AxiosResponse) => {
      if(res.data){
  ...
  render(){
    let {oldPassword, newPassword, rePassword, alert} = this.state;
    return (
      <div className="card">
        ...
        <div className="card-body">
          <form onSubmit={this.handleSubmit}>
            ...
            <div className="form-group row">
              <label htmlFor="Email" className="col-2">Old Password</label>
              <div className="col-10">
                <input type="password" className="form-control" id="Email" placeholder="Old Password" name="oldPassword" value={oldPassword} onChange={this.handleInput}/>
              </div>
            </div>
            <div className="form-group row">
